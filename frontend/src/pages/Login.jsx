...
import { Delete, CornerDownLeft, User, Lock, Eye, EyeOff, ArrowLeft, Loader2, AlertTriangle, CreditCard, Phone } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-100 to-gray-200">
      ...
      <Dialog open={showExpiredModal} onOpenChange={setShowExpiredModal}>
        <DialogContent className="sm:max-w-md" data-testid="subscription-expired-modal">
          <DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-gray-500">
                Për të vazhduar përdorimin e sistemit, ju lutem kontaktoni administratorin për të rinovuar abonimin.
              </p>
            </div>
